...
if __name__=="__main__":
    ...
    for im in impacts:
        learner = sl.StrategyLearner(verbose = False, impact = im) # constructor
        ...
        pv = ma.compute_portvals(df_trades, start_val = sv, commission=9.95, impact=im)
        ...
        print "For impact = {}".format(im)
        print "Number of Trades {}".format(len(df_trades))
        print
